...
impl HttpResponse {
    pub fn new(raw_response: String) -> Result<Self, Error> {
        ...
        //事前処理されたレスポンスを、status_lineとremainingに分ける
        ...
        Ok(Self { version:statuses[0].to_string(), status_code: statuses[1].parse().unwrap_or(404), reason: statuses[2].to_string(), headers, body: body.to_string() })
    }
